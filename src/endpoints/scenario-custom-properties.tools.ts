...
import type { ScenarioCustomPropertiesData } from './scenario-custom-properties.js';
...
export const tools: MakeTool[] = [
    ...
    },
    {
        ...
        execute: async (make: Make, args: { scenarioId: number; customProperties: ScenarioCustomPropertiesData }) => {
